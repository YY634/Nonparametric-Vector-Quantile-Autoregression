...
load("./simulations/main/case2_predictive.RData")
load("./simulations/main/case2_VAR_predictive.RData")
load("./simulations/main/case2_stationary.RData")
load("./simulations/main/case2_VAR_stationary.RData")
load("./simulations/main/plot_case2_figure4.RData")
