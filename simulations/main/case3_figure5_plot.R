...
load("./simulations/main/case3_predictive.RData")
load("./simulations/main/case3_VAR_predictive.RData")
load("./simulations/main/case3_stationary.RData")
load("./simulations/main/case3_VAR_stationary.RData")
load("./simulations/main/plot_case3_figure5.RData")
...
for (i in 1:9){
  ...
  if (i < 5){
    ...
    plot(quant2[,2:3], type = "l", col = "orange", lwd = 2, xlim = c(-1.8, 2.5), ylim = c(-1.5, 2.5), asp=1,  xaxt ="n", yaxt = "n", xlab = "", ylab = "") 
    ...
    plot(quant2[,1:2], type = "l", col = 'orange', lwd = 2, xlim = c(-1.8, 2.5), ylim = c(-1.5, 2.5), xaxt ="n", yaxt = "n",  asp=1, xlab = "", ylab = "") 
    xticks <- c(-2, -1, 0, 1, 2);  axis(1, at = xticks, labels = round(xticks, 0))
    yticks <- c(0, 1, 2, 3, 4);  axis(2, at = yticks, labels = round(yticks, 0))
