...
X1 <- samp[1:20001,];  k_S <- 200; k_R <- 100; qgridn <- 360  
Upper_left <- Cond_Quantile(tims, h, qgridn, X1, k_S, k_R, d=2)
rm(X1)

X2 <- samp[1:80001,];  k_S <- 200; k_R <- 100; qgridn <- 360 
Upper_right <- Cond_Quantile(tims, h, qgridn, X2, k_S, k_R, d=2)
rm(X2)

X3 <- samp[1:400001,];  k_S <- 200; k_R <- 100; qgridn <- 360 
Lower_left <- Cond_Quantile(tims, h, qgridn, X3, k_S, k_R, d=2)
rm(X3)

theoretic <- Cond_Quantile(tims, h, qgridn, samp, k_S, k_R, d=2)

save(Upper_left, Upper_right, Lower_left, theoretic, file = "./simulations/appendix/Figures/app_case2_fig6.RData")
...
load("./simulations/appendix/Figures/app_case2_view.RData")
load("./simulations/appendix/Figures/app_case2_plot.RData")
...
rglwidget() 
snapshot3d("./simulations/appendix/Figures/case2_upper_left.png", width = 2000, height = 2000) 
...
grid3d_faces(nx = 6, ny = 4, nz = 4, x_plane = "min", y_plane = "max", z_plane = "min", col = "gray", lwd = 1)
rglwidget() 
snapshot3d("./simulations/appendix/Figures/case2_upper_right.png", width = 2000, height = 2000) 
...
grid3d_faces(nx = 6, ny = 4, nz = 4, x_plane = "min", y_plane = "max", z_plane = "min", col = "gray", lwd = 1)
rglwidget() 
snapshot3d("./simulations/appendix/Figures/case2_lower_left.png", width = 2000, height = 2000) 
...
grid3d_faces(nx = 6, ny = 4, nz = 4, x_plane = "min", y_plane = "max", z_plane = "min", col = "gray", lwd = 1)
rglwidget() 
snapshot3d("./simulations/appendix/Figures/case2_lower_right.png", width = 2000, height = 2000) 
