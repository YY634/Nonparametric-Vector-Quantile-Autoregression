...
save(Upper_left, Upper_right, Lower_left, theoretic, file = "./simulations/appendix/Figures/app_case1_fig3.RData")
...
load("./simulations/appendix/Figures/app_case1_view.RData")
load("./simulations/appendix/Figures/app_case1_plot.RData")
...
rglwidget() 
snapshot3d("./simulations/appendix/Figures/case1_upper_left.png", width = 2000, height = 2000) 
...
grid3d_faces(nx = 8, ny = 4, nz = 4, x_plane = "min", y_plane = "max", z_plane = "min", col = "gray", lwd = 1)
rglwidget() 
snapshot3d("./simulations/appendix/Figures/case1_upper_right.png", width = 2000, height = 2000) 
...
grid3d_faces(nx = 8, ny = 4, nz = 4, x_plane = "min", y_plane = "max", z_plane = "min", col = "gray", lwd = 1)
rglwidget() 
snapshot3d("./simulations/appendix/Figures/case1_lower_left.png", width = 2000, height = 2000) 
...
grid3d_faces(nx = 8, ny = 4, nz = 4, x_plane = "min", y_plane = "max", z_plane = "min", col = "gray", lwd = 1)
rglwidget() 
snapshot3d("./simulations/appendix/Figures/case1_lower_right.png", width = 2000, height = 2000) 
